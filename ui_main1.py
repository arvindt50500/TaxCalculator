...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/Icon/icons/20x20/cil-menu.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/Icon/icons/20x20/cil-home.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.LIST.setText(" ADD")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/Icon/icons/20x20/cil-medical-cross.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/Icon/icons/20x20/cil-library.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/Icon/icons/20x20/cil-settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/Icon/icons/20x20/cil-lightbulb.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"color: rgb(85, 0, 255);")
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/Button/icons/feather/x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/Button/icons/feather/maximize.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/Button/icons/feather/minus.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.FromDate = QtWidgets.QDateTimeEdit(self.FILTERWINDOW)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        self.FromDate.setFont(font)
        self.FromDate.setStyleSheet("border-width: 15px;\n"
"color: rgb(26, 26, 26);\n"
...
"font: 9pt \"Segoe UI\";")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.LIST.setToolTip(_translate("MainWindow", "ADD"))
        self.ADD.setToolTip(_translate("MainWindow", "LIST"))
        self.ADD.setText(_translate("MainWindow", " LIST"))
        ...
        self.FaText.setPlainText(_translate("MainWindow", "nnn\n"
""))
...
class DFEditor(QtWidgets.QWidget):
    global df2
    print("Executing Def")
    file_exists = str(exists('C:\TDS1\master.db'))
    print("Executing Def"+file_exists+'C:\TDS1\master.db')
    if 'F' in file_exists:
        def __init__(self):
            super().__init__()
        ...
        def export_to_csv(self):
            file=open("2.txt","r")
            path = 'C:/ProgramData/Rmsi_Australia/NBN_BDOD/SSC Tools/BOMBOQ-SSC'
            try:
                dp = path
                xl = Dispatch("Excel.Application")
                s = xl.Workbooks.Open(dp)
            except Exception as e:
               print("Error:DESIGN-BOMBOQ excel is Not Found")
            xl.Visible = True
            d1 = s.Worksheets('BOQ (On Demand)')
            d2 = s.Worksheets('BOM')
            d3 = s.Worksheets('Summary')
            dgndata = pd.read_excel("DESIGN-BOMBOQ.xlsx",sheet_name = 1)
            dfparent = self.table.df
            for item in dfparent.itertuples():
                it = list(item)
                it1= it[1]
                it2 = float(it[3])
                it21 = str(it[2])
                dgndata1 = dgndata[dgndata["Item Code"] == it1]
                dgndata2 = dgndata1["Item Code"]
                dgndata2 = list(dgndata2.index)
                dgndata2len = len(dgndata2)
                if dgndata2len > 0:
                    if "DFN" in it21:
                        dgndata2row = (dgndata2[1])+2
                    else:
                        dgndata2row = (dgndata2[0])+2
                    y1 = str(d1.Cells(dgndata2row,7).value)
                    if "None" in y1:
                        y1 = 0
                    else:
                        y1 = float(y1)
                    if "DFN" in it21:
                        d1.Cells(dgndata2row,6).value = it2 + y1
                        d1.Cells(dgndata2row,5).value = it2 + y1
                    else:
                        d1.Cells(dgndata2row,7).value = it2 + y1
                        d1.Cells(dgndata2row,5).value = it2 + y1
